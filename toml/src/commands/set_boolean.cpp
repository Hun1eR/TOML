...
/// <summary>
/// </summary>
SetBooleanCommand::SetBooleanCommand(const cell handle, const char* key, const cell value)
...
/// <summary>
/// </summary>
SetBooleanCommand::SetBooleanCommand(const cell handle, cell index, const cell value)
	: handle_(handle), value_(value)
{
...
/// <summary>
/// </summary>
cell SetBooleanCommand::execute()
{
...
cell AMX_NATIVE_CALL toml_set_bool(Amx* amx, cell* params)
{
	...
	SetBooleanCommand command(handle, key, value);
...
/// <summary>
/// </summary>
cell AMX_NATIVE_CALL toml_array_set_bool(Amx* amx, cell* params)  // NOLINT(readability-non-const-parameter)
{
	...
	const auto value = params[Value];
	SetBooleanCommand command(handle, index, value);
