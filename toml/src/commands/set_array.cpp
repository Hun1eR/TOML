...
/// <summary>
/// </summary>
SetArrayCommand::SetArrayCommand(const cell handle, const char* key, const cell value) : handle_(handle), value_(value)
{
...
/// <summary>
/// </summary>
SetArrayCommand::SetArrayCommand(const cell handle, cell index, const cell value) : handle_(handle), value_(value)
{
...
cell AMX_NATIVE_CALL toml_set_array(Amx* amx, cell* params)
{
	...
	SetArrayCommand command(handle, key, value);
...
/// <summary>
/// </summary>
cell AMX_NATIVE_CALL toml_array_set_array(Amx* amx, cell* params)  // NOLINT(readability-non-const-parameter)
{
	...
	const auto value = params[Value];
	SetArrayCommand command(handle, index, value);
